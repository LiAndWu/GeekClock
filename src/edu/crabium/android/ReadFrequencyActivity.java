...
public class ReadFrequencyActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (MoreActivity.ReadFrequencyHour == 0) {
			m_ReadFrequencyTextView.setText("ﾏﾖﾔﾚｵﾄﾋ｢ﾐﾂﾆｵﾂﾊﾊﾇ｣ｺ\nﾃｿ" + MoreActivity.ReadFrequencyMinute + "ｷﾖﾖﾓﾒｻｴﾎ");
		} else if (MoreActivity.ReadFrequencyMinute == 0) {
			m_ReadFrequencyTextView.setText("ﾏﾖﾔﾚｵﾄﾋ｢ﾐﾂﾆｵﾂﾊﾊﾇ｣ｺ\nﾃｿ" + MoreActivity.ReadFrequencyHour + "ﾐ｡ﾊｱﾒｻｴﾎ");
		} else {
			m_ReadFrequencyTextView.setTextSize(17);
			m_ReadFrequencyTextView.setText("ﾏﾖﾔﾚｵﾄﾋ｢ﾐﾂﾆｵﾂﾊﾊﾇ｣ｺ\nﾃｿ" + MoreActivity.ReadFrequencyHour + 
					"ﾐ｡ﾊｱ" + MoreActivity.ReadFrequencyMinute + "ｷﾖﾖﾓﾒｻｴﾎ");
		}
